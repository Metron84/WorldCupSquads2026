          ...
          <table className="min-w-full text-left text-sm">
            <thead className="border-b border-slate-200 text-xs uppercase text-slate-500">
              <tr>
                ...
                <th className="px-2 py-2" title="World Cup qualifying (FBref WCQ sheets)">
                  WCQ MP
                </th>
                <th className="px-2 py-2" title="World Cup qualifying minutes">
                  WCQ Min
                </th>
                <th className="px-2 py-2" title="World Cup qualifying goals">
                  WCQ Gls
                </th>
                <th className="px-2 py-2" title="World Cup qualifying assists">
                  WCQ Ast
                </th>
            ...
            <tbody>
              {players.map((player) => (
                <tr key={`${title}-${player.player}`} className="border-b border-slate-100">
                  ...
                  <td className="px-2 py-2 text-slate-600">{player.wcq?.mp ?? "—"}</td>
                  <td className="px-2 py-2 text-slate-600">{player.wcq?.minutes ?? "—"}</td>
                  <td className="px-2 py-2 text-slate-600">{player.wcq?.goals ?? "—"}</td>
                  <td className="px-2 py-2 text-slate-600">{player.wcq?.assists ?? "—"}</td>
